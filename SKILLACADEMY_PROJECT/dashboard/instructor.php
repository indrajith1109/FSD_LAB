...
<a href="edit_course.php?id=<?php echo (int) $course['id']; ?>" class="btn" style="background:#16a34a;color:white;margin-bottom:8px;">
Edit Course
</a>

<a href="course_students.php?id=<?php echo (int) $course['id']; ?>" class="btn" style="background:#4f46e5;color:white;margin-bottom:8px;">
Manage Students
</a>
